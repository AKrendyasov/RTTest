...
folder are mapped to the application's root namespace, 'RTTask'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'RTTask' in the same way
as `"RTTask/sass/src"`.
